...
{
   // NSLog(@"CgiPacket...UppacketAlarmParams()");
    SscanfInt(pszBuffer,"alarm_motion_armed=",t.motion_armed) ;
    SscanfInt(pszBuffer,"enable_alarm_audio=",t.enable_alarm_audio) ;
...
int CCgiPacket::UnpacketUserinfo(const char *pszBuffer,STRU_USER_INFO &t)
{
	...
	SscanfString(pszBuffer,"user1_name=",t.user1);
    ...
    SscanfInt(pszBuffer,"model=",t.model);
...
int CCgiPacket::UnpacketDatetimeParam(const char *pszBuffer,STRU_DATETIME_PARAMS &t)
{
    ...
    SscanfInt(pszBuffer,"ntp_enable=",t.ntp_enable);
    SscanfString(pszBuffer,"ntp_svr=",t.ntp_svr) ;
     SscanfInt(pszBuffer,"xia_ling_shi_flag_status=",t.xia_ling_shi_flag_status);
    return 1;
}
...
int CCgiPacket::UnpacketSdCardRecordParam(const char * pszBuffer,STRU_SD_RECORD_PARAM & t)
{
     ...
     */
    SscanfInt(pszBuffer,"record_cover_enable=",t.record_cover_enable) ;
    ...
    SscanfInt(pszBuffer,"enable_record_audio=",t.enable_record_audio) ;
...
int CCgiPacket::UnpacketWifiParams(const char *pszBuffer, STRU_WIFI_PARAMS &t)
{
    ...
    SscanfInt(pszBuffer,"wifi_enable=",t.enable) ;
    ...
    SscanfInt(pszBuffer,"wifi_link_status=",t.wifi_link_status) ;
...
int  CCgiPacket::UnpacketSetResult(const char *pszBuffer)
{
    ...
    int result=-1;
    SscanfInt(pszBuffer, "result=", result);
    //	char buf[100]={0};
