...
-(void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data{
    ...
    switch (paramType) {
        ...
        case WifiType:
        {
            ...
            if (m_CgiPacket.UnpacketWifiParams((char *)[str UTF8String], wifiParams))
            {
                if(wifiProtocol!=nil){
                    ...
                    [wifiProtocol WifiProtocolResult:wifiParams];
                }
            }
        ...
        case UserType:
        {
            ...
            {
                if (userProtocol !=nil) {
                    [userProtocol UserProtocolResult:userInfo];
        ...
        case DateType:
        {
            ...
            {
                if (dateProtocol != nil) {
                    [dateProtocol DateTimeProtocolResult:datetimeParams];
        ...
        case AlarmType:
        {
            ...
            if (m_CgiPacket.UppacketAlarmParams((char *)[str UTF8String], alarm))
            {
                if (alarmProtocol != nil) {
                    [alarmProtocol AlarmProtocolResult:alarm];
        ...
        case FTPType:
        {
            ...
            if (m_CgiPacket.UnpacketFtpParam((char *)[str UTF8String], ftpParam))
            {
                ...
                if (ftpProtocol != nil) {
                    [ftpProtocol FtpProtocolResult:ftpParam];
                }
        ...
        case MailType:
        {
            ...
            {
                if (mailProtocol!=nil) {
                    [mailProtocol MailProtocolResult:mailParam];
                }
        ...
        NSString *str=[[NSString alloc]initWithData:data encoding:NSASCIIStringEncoding];
            ...
            {
                if (sdcardProtocol) {
                    [sdcardProtocol SDCardProtocolResult:recordParam];
                }
            ...
            for (i = 0; i < nCount; i++)
            {
                ...
                if (wifiProtocol!=nil) {
                    if ([wifiProtocol respondsToSelector:@selector(WifiScanResult:ssid:mac:security:db0:db1:mode:channel:bEnd:)]) {
                        [wifiProtocol WifiScanProtocolResult:wifiSearchResultList.wifi[i]];
                    }
