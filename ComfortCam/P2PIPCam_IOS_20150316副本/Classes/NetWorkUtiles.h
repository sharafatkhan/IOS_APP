...
@interface NetWorkUtiles : NSObject<NSURLConnectionDelegate,NSURLConnectionDataDelegate>
{
    ...
    id<PPPPObjectProtocol> userProtocol;
    id<PPPPObjectProtocol> wifiProtocol;
    id<PPPPObjectProtocol> alarmProtocol;
    id<PPPPObjectProtocol> dateProtocol;
    id<PPPPObjectProtocol> ftpProtocol;
    id<PPPPObjectProtocol> mailProtocol;
    id<PPPPObjectProtocol> imageNotifyProtocol;
    id<PPPPObjectProtocol> sdcardProtocol;
    int paramType;
    int wifiscanType;
    NSCondition *mLock;
...
@property (nonatomic, assign)id<NetworkUtilesProtocol> networkProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> userProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> wifiProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> alarmProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> dateProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> ftpProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> mailProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> imageNotifyProtocol;
@property (nonatomic, assign)id<PPPPObjectProtocol> sdcardProtocol;
//get
